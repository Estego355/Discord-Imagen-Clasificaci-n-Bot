...
Este proyecto consiste en un clasificador de imágenes entrenado con inteligencia artificial. Lo que hace el modelo es analizar una imagen, ya sea tomada desde la cámara o cargada desde un archivo, y determinar a cuál de estos tres personajes pertenece. El resultado no es simplemente un nombre, sino un porcentaje de probabilidad que indica qué tan seguro está el modelo de su decisión.
...
Durante el entrenamiento, el sistema analizó cientos de ejemplos por clase y ajustó automáticamente sus parámetros internos para reconocer patrones comunes dentro de cada grupo. El proceso incluyó pruebas en tiempo real para verificar la precisión y evitar que el modelo confundiera a Goku con Goku Black, que es uno de los desafíos principales debido a su gran parecido.
